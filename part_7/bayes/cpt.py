...
def get_conditional_probability(data, query, condititions):
    ...
    print(query, condititions)
    query.update(condititions)
    return get_data_frequency(data, query) / (get_data_frequency(data, condititions) + epsilon)
    # =========================================================
...
def exhaustive_enum(G, X, E, e):
    ...
    for assignment in assignments:
        ...
        for node in G.nodes:
            ...
            # CODE HERE!
            # =========================================================
            tmp *= evaluate_node(G, node.data_id, combined_dictionary[node.data_id], combined_dictionary)
        total += tmp
    return total
...
def sample(G, X, E, e):
    ...
    for variable in X:
        ...
        if variable in E:
            ...
            # CODE HERE
            # =========================================================
            prob = evaluate_node(G, variable, 1, parents)
